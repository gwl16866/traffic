<template>
  <div>
    ...
    <el-dialog title="审核相片" :visible.sync="studentAuditVisible">
      <updateStudent v-if="studentAuditVisible"  :stuid="studentId" @updateSuccessClick="updateSuccessClick"/>
    </el-dialog>
    <!-- --------------------操作弹出框结束------------------------------------------------------------------------ -->
	</div>
  </div>
...
<script>
import studentAudit from '@/components/page/studentInfo/updateStudent'
export default {
    data(){
      return{
        studentList: [],
