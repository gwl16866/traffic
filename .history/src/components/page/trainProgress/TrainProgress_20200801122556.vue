...
<div>
    ...
    <div class="pro">
        ...
        <el-progress :text-inside="true" :stroke-width="12" :percentage="if(Teachinfo.allProper==0?'0':Number(Teachinfo.okProper/Teachinfo.allProper*100).toFixed(2))"></el-progress>
    </div>
