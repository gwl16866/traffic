...
       
          ...
          <el-table :data="queryZhuTiClass" style="width: 100%">
            <el-table-column prop="project" label="日期" width="900">
              <el-table-column prop="oneTitle,vedio,vedioTime" label="project" width="900">
              <template slot-scope="scope">
              <!--  <video src=""></video> -->
              <button @click="checkVideoFun('scope.row.vedio')"><i class="el-icon-video-play" ></i>
              </button>
                {{scope.row.oneTitle}}
