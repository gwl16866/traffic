    ...
    <el-table :data="tableData" >
        ...
        <el-table-column width="250" >
            <template slot-scope="scope">
              ...
              <el-progress :text-inside="true" :stroke-width="12" :percentage="scope.row.okProper/scope.row.allProper*100"></el-progress>
            </template>
        </el-table-column>
        ...
        <el-table-column  width="240">
          <template slot-scope="scope">
            ...
            <el-link type="success" @click="selectCanXun(scope.row)">考试详情</el-link>&emsp;&emsp;
          </template>
        </el-table-column>
    </el-table>
