...
        <el-table :data="queryZhuTiClass" style="width: 100%">
          <el-table-column prop="oneTitle,vedioTime" label="日期" width="180">
             <template slot-scope="scope">
             <!--  <video src=""></video> -->
             <!-- <button @click="checkVideoFun('https://cdn.course.ggjtaq.com/zizhikejian/shiguanli/weixianpinyunshushiguanli.mp4')">
             </button> -->
             <div icon='el-icon-search' @click="checkVideoFun('https://cdn.course.ggjtaq.com/zizhikejian/shiguanli/weixianpinyunshushiguanli.mp4')"></icon>
               {{scope.row.oneTitle}}
               {{scope.row.vedioTime}}
            </template>
          </el-table-column>
