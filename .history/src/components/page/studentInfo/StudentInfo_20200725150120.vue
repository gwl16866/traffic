		...
		methods: {
			...
			queryAllStudent(){
				...
				if (currThis.student.createTime != null && currThis.student.endTime != null) {
					startTimes = currThis.$moment(currThis.student.createTime).format('YYYY-MM-DDTHH:mm:ss')
					endTimes = currThis.$moment(currThis.student.endTime).format('YYYY-MM-DDTHH:mm:ss')
				}
