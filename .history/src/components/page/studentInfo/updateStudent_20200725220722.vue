...
<div class="el-form-item el-form-item--small"><!----><div class="el-form-item__content" style="margin-left: 110px;"><div class="avatar-uploader"><div tabindex="0" class="el-upload el-upload--text"><img src="http://www.0622cc.cn/group1/M00/00/02/rBUAEF8GdIOACO0vAABHN5TaaZc966.jpg"><input type="file" name="file" class="el-upload__input"></div></div><!----></div></div>
