        ...
        <el-form-item label="学员姓名">
          <el-input v-model="student.realName" placeholder="用户姓名" />
				...
				<el-form-item label="录入时间">
					...
					<el-col :span="11">
						<el-date-picker v-model="student.endTimes" type="date" placeholder="选择日期" />
					</el-col>
				</el-form-item>
	...
	export default {
		...
		methods: {
			...
			queryAllStudent(){
				...
				let createTime = ''
				let endTimes = ''
				if (currentThis.student.createTime != null && currentThis.student.endTimes != null) {
					createTime = currentThis.$moment(currentThis.student.createTime).format('YYYY-MM-DDTHH:mm:ss')
					endTimes = currentThis.$moment(currentThis.student.endTime).format('YYYY-MM-DD')
				}
