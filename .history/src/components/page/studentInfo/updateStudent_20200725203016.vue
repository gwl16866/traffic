    ...
    <el-form :model="student" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="岗位名称" prop="region">
        <el-select class="y" v-model="student.jobName" placeholder="请选择活动区域">
          ...
          <el-option label="场站管理人员" value="beijing"></el-option>
          <el-option label="装卸员" value="beijing"></el-option>
          <el-option label="压运员" value="beijing"></el-option>
          <el-option label="乘务员" value="beijing"></el-option>
          <el-option label="后勤人员" value="beijing"></el-option>
          <el-option label="安全员" value="beijing"></el-option>
          <el-option label="安全检查员" value="beijing"></el-option>
          <el-option label="公交车驾驶员" value="beijing"></el-option>
          <el-option label="旅游驾驶员" value="beijing"></el-option>
          <el-option label="工程车驾驶员" value="beijing"></el-option>
          <el-option label="教练员" value="beijing"></el-option>
          <el-option label="监控人员" value="beijing"></el-option>
          <el-option label="办公室管理人员" value="beijing"></el-option>
          <el-option label="网约车驾驶员" value="beijing"></el-option>
          <el-option label="车主" value="beijing"></el-option>
          <el-option label="大队负责人" value="beijing"></el-option>
          <el-option label="大队副职" value="beijing"></el-option>
          <el-option label="分管安全领导" value="beijing"></el-option>
          <el-option label="科室负责人" value="beijing"></el-option>
          <el-option label="科员" value="beijing"></el-option>
          <el-option label="其他管理人员" value="beijing"></el-option>
          <el-option label="企业副职领导" value="beijing"></el-option>
          <el-option label="校车照管员" value="beijing"></el-option>
        </el-select>
      </el-form-item>
