      ...
      this.$refs[stus].validate((valid) => {
        if (valid) {
          const currThis = this
            ...
            currThis.student.busCarefulTimes = currThis.$moment(currThis.seckill.startTime).format('YYYY-MM-DDTHH:mm:ss')
            currThis.student.createTimes = currThis.$moment(currThis.seckill.endTime).format('YYYY-MM-DDTHH:mm:ss')
