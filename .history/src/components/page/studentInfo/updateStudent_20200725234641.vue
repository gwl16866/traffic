    ...
    <el-form :model="student" label-position="left" :rules="rules" ref="stus" label-width="120px" class="demo-ruleForm">
      ...
      <el-form-item label="驾驶证到期时间" prop="driverOverTime">
        <el-col :span="11" class="y1">
          <el-date-picker  type="date" placeholder="选择日期" v-model="student.driverOverTimes" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>

      <el-form-item label="车辆年审时间" prop="busCarefulTime">
         <el-col :span="11" class="y1">
          <el-date-picker  type="date" placeholder="选择日期" v-model="student.busCarefulTimes" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>
      ...
      <el-input type="hidden" v-model="student.createTimes"></el-input>

      <el-form-item label="入职时间" prop="induction">
        <el-col :span="11" class="y1">
          <el-date-picker  type="date" placeholder="选择日期" v-model="student.inductions" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>
    ...
    queryStudentById(){
      ...
      currentThis.$axios.get('http://localhost:8081/studentinfo/queryStudentById',{
          ...
          if (currentThis.headImg !== '') {
            console.log("aaaa--------"+currentThis.headImg)
