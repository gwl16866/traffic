  ...
  <div>
    <el-form :model="student" label-position="left" :rules="rules" ref="stus" label-width="120px" class="demo-ruleForm">
      ...
      <el-form-item label="真实姓名" prop="realName" >
        <el-input class="y" v-model="student.realName" placeholder="选择输入真实姓名"></el-input>
      </el-form-item>

      <el-form-item label="身份证号" prop="cardId">
        <el-input class="y" v-model="student.cardId" placeholder="选择输入身份证号"></el-input>
      </el-form-item>
      ...
      <el-form-item label="驾驶证到期时间" prop="driverOverTime">
        <el-col :span="11" class="y1">
          <el-date-picker  type="date" placeholder="选择驾驶证日期" v-model="student.driverOverTime" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>
