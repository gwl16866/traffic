<template>
  <div>
    <el-form :model="student" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="从业证号" prop="name">
        <el-input class="y" v-model="student.realName"></el-input>
      </el-form-item>

      <el-table-column label="驾驶证到期时间" align="center" min-width="30%">
        <template slot-scope="scope">
          {{ scope.row.createTime }}
        </template>
      </el-table-column>

      <el-table-column label="车辆年审时间" align="center" min-width="30%">
        <template slot-scope="scope">
          {{ scope.row.createTime }}
        </template>
      </el-table-column>
      ...
      <el-form-item label="岗位名称" prop="region">
        <el-select class="y" v-model="student.jobName" placeholder="请选择活动区域">
          <el-option label="客运"         value="驾驶员"></el-option>
          <el-option label="普货"     value="客运驾驶人"></el-option>
          <el-option label="危险品"     value="危货驾驶人"></el-option>
          <el-option label="出租车"     value="普货驾驶人"></el-option>
          <el-option label="安管人员"   value="出租车驾驶人"></el-option>
          <el-option label="押运员"     value="企业负责人"></el-option>
          <el-option label="卸货员"   value="安全管理人员"></el-option>
          <el-option label="乘务员"       value="维修人员"></el-option>
          <el-option label="维修人员"   value="场站管理人员"></el-option>
          <el-option label="站场管理"         value="装卸员"></el-option>
        </el-select>
      </el-form-item>

      <el-table-column label="入职时间" align="center" min-width="30%">
        <template slot-scope="scope">
          {{ scope.row.createTime }}
        </template>
      </el-table-column>

      <el-table-column label="群主名称" align="center" min-width="30%">
        <template slot-scope="scope">
          {{ scope.row.createTime }}
        </template>
      </el-table-column>
