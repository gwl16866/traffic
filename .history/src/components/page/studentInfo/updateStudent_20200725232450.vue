  ...
  data() {
    return {
      ...
      rules: {
          ...
          busNum: [
            { type: 'date', required: true, message: '车牌号码', trigger: 'blur' },
          ...
          driverOverTime: [
            { type: 'date', required: true, message: '请选择驾驶证到期时间', trigger: 'change' }
          ],
          busCarefulTime: [
            { type: 'date', required: true, message: '请选择车辆年审时间', trigger: 'change' }
          ],
          linkAddress: [
            { required: true, message: '请输入联系地址', trigger: 'blur' }
          ],
          jobType: [
            { required: true, message: '请选择从业类型', trigger: 'change' }
          ],
          induction: [
    ...
    queryStudentById(){
      ...
      currentThis.$axios.get('http://localhost:8081/studentinfo/queryStudentById',{
          ...
          if (currThis.headImg !== '') {
            ...
            currThis.student.headImg = currThis.headImg
          }
				})
