  ...
  <div>
    <el-form :model="student" label-position="left" :rules="rules" ref="stus" label-width="120px" class="demo-ruleForm">
      ...
      <el-form-item label="身份证号" prop="cardId">
        <el-input class="y" v-model="student.cardId" placeholder="请输入真实姓名"></el-input>
      </el-form-item>
      <el-form-item label="联系电话" prop="linkNum">
        <el-input class="y" v-model="student.linkNum" placeholder="请输入真实姓名"></el-input>
      </el-form-item>
      ...
      <el-form-item label="车牌号码" prop="busNum">
        <el-input class="y" v-model="student.busNum" placeholder="请输入真实姓名"></el-input>
      </el-form-item>
      ...
      <el-form-item label="从业证号" prop="employedNum">
        <el-input  v-model="student.employedNum" placeholder="请输入真实姓名"></el-input>
      </el-form-item>
      ...
      <el-form-item label="联系地址" prop="linkAddress">
        <el-input  v-model="student.linkAddress" placeholder="请输入真实姓名"></el-input>
      </el-form-item>
      ...
      <el-form-item size="large">
        <el-button type="primary" @click="addStudent('stus')">确定添加</el-button>
