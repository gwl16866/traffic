<template>
  <div>
    <el-form :model="student" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-divider content-position="left"><h1>可选信息</h1></el-divider>

      <el-form-item label="从业证号" prop="name">
        <el-input class="y" v-model="student.employedNum"></el-input>
      </el-form-item>

      <el-form-item label="驾驶证到期时间">
        <el-col :span="11">
          <el-date-picker class="y" type="date" placeholder="选择日期" v-model="student.driverOverTime" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>

      <el-form-item label="车辆年审时间">
        <el-col :span="11">
          <el-date-picker class="y" type="date" placeholder="选择日期" v-model="student.busCarefulTime" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>

      <el-form-item label="联系地址" prop="name">
        <el-input class="y" v-model="student.linkAddress"></el-input>
      </el-form-item>

      <el-form-item label="从业类型" prop="region">
        <el-select class="y" v-model="student.jobType" placeholder="请选择活动区域">
      ...
      <el-form-item label="入职时间">
        <el-col :span="11">
          <el-date-picker class="y" type="date" placeholder="选择日期" v-model="student.induction" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>
