  ...
  <div>
    <el-form :model="student" label-position="left" ref="stus" label-width="120px" class="demo-ruleForm">
      ...
      <el-form-item label="相片审核状态">
          ...
          <el-option label="{{student.headImgStatus===4 ?'待审核'}}"   value="4"></el-option>
          <el-option label="{{student.headImgStatus===4 ?'通过'}}"     value="5"></el-option>
          <el-option label="{{student.headImgStatus===4 ?'未通过'}}"   value="6"></el-option>
        </el-select>
      </el-form-item>
