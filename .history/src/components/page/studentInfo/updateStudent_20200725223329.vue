    ...
    return {
      ...
      rules: {
          ...
          cardId: [
            ...
            { min: 18, max: 18, message: '长度在 3 到 5 个字符', trigger: 'blur' }
          ],
          linkNum: [
          ...
          employedNum: [
            { type: 'array', required: true, message: '从业证号', trigger: 'change' }
          ],
          driverOverTime: [
            { required: true, message: '驾驶证到期时间', trigger: 'change' }
            { type: 'date', required: true, message: '请选择日期', trigger: 'change' }
          ],
          busCarefulTime: [
            { required: true, message: '车辆年审时间', trigger: 'change' }
          ],
          linkAddress: [
            { required: true, message: '联系地址', trigger: 'blur' }
          ],
          jobType: [
            { required: true, message: '从业类型', trigger: 'blur' }
          ],
          induction: [
